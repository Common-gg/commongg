    ...
    return (
        <div className="NavigationBar" style={{ color: "#BF9AFC" }}>
            ...
            <Link to="/following" style={linkStyle}>
                <p style={pageState==="following"?selectedStyle:null}><img src={follow} style={iconStyle} alt="" /> following</p>
            </Link>
            <Link to="/trending" style={linkStyle}>
                <p style={pageState==="trending"?selectedStyle:null}><img src={trend} style={iconStyle} alt="" /> trending</p>
            </Link>
            {gamesArr.map((game) => {
