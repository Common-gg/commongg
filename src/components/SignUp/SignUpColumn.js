        ...
        <div className="SignUpColumn">
            <div className="form-row">
                <div className="col-md-6 mb-3">
                    ...
                    <Input type="text" id="validationDefault01" placeholder="Useremail@email.com" ref={props.emailRef}/>
                </div>

                <div className="col-md-6 mb-3">
                    <Label htmlFor="validationDefault02" text="Password"/>
                    <Input type="password" id="validationDefault02" placeholder="Password" ref={props.emailRef}/>
                </div>
            </div>
        </div>
    );
